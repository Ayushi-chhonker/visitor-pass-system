...
/*
Visitor Pass Routes: This file contains all routes related to visitor pass
management.
...
It allows authorized users to:
 ...
 Verify a visitor pass using QR data
*/

// Create Express Router
const router = express.Router();
//generate visitor pass
// Logged-in users can generate a visitor pass.
...
// Only Admin and Security staff can download, the printable visitor pass.
router.get("/:id/pdf", authMiddleware, roleMiddleware("admin", "security"),generatePassPDF);
// Verify Visitor Pass
// Verifies the QR-based visitor pass and updates
// the visitor's check-in/check-out status.
