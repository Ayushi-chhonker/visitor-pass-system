...
management.
It allows authorized users to: Create appointments, View appointment records, Approve appointments, Record visitor check-in, Record visitor check-out
*/
